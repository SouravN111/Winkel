  ...
  <body class="goto-here">
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-md-6">
          <form action="UserController" method="post" class="bg-white p-5 contact-form">
            ...
            <div class="form-group">
              <input type="password" class="form-control" placeholder="Confirm new password" name="cnew_password" required>
            </div>
            <div class="form-group text-center">
              <input type="submit" value="Change password" class="btn btn-primary py-3 px-5" name="action">
            </div>
          </form>
        </div>
      </div>
