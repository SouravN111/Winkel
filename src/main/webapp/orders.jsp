    				...
    				<div class="cart-list scrollremove">
	    				<table class="table">
						    ...
						    <%
						    	...
						    	List<Cart> list = CartDao.getOrdersByAllUser();
						    	for(Cart c : list){
						    ...
						    %>
						      ...
						      <tr class="text-center">
						        <td class="product-remove"><a href="remove-from-orders.jsp?pid=<%=p.getPid() %>"><span class="ion-ios-close"></span></a></td>
						        <td class="uname"><%=user.getFname() %></td>
						        	...
						        	<form method="post" action="change_qty.jsp">
							        	<div class="input-group mb-3">
							        		<input type="hidden" name="cid" value="<%=c.getCid()%>">
						             		<input type="number" name="product_qty" class="quantity form-control input-number" readonly="readonly" value="<%=c.getProduct_qty() %>" min="1" max="10" onchange="this.form.submit()">
